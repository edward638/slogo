...
public final class BorderPaneConstants {
    public static final int DRAWER_X = 15;
    public static final int DRAWER_Y = 15;

    public static final int COMMAND_HISTORY_BOX_X = 520;
    public static final int COMMAND_HISTORY_BOX_Y = 200;

    public static final int VARIABLE_HISTORY_BOX_X = 740;
    ...
    public static final int HELP_BUTTON_X = 890;
