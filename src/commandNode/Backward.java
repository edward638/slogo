...
public class Backward extends Node implements CommandNode
{
	...
	{
		double xCor = turtle.getXCoordinate() - arguments.get(0).getValue()*Math.sin(turtle.getDirectionAngle()*radianConversion);
		double yCor = turtle.getYCoordinate() - arguments.get(0).getValue()*Math.cos(turtle.getDirectionAngle()*radianConversion);
